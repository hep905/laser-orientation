...
-   I notice four columns with student id, course id,
    total_points_possible, and total_points_earned

-   I wonder how to delete the column "course_id"
...
-   student online course total point earned

What columns typically (or you think may) represent:

-   student_id, subject, gender
...
-   I changed the cut-off from 70 to 80, and found the case reduce from
    438 to 355.
...
```{r}
m2 <- lm(FinalGradeCEMS ~ TimeSpent + subject + Points_Earned, data = d)
summary(m2)
```
